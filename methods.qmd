...
Applying the exclusion criterion reduces the sample size from `r orig_len` songs to `r len` songs.
...
spotify_songs$popularity = as.factor(ifelse(spotify_songs$track_popularity <= 33, 'low', 
                                     ifelse(spotify_songs$track_popularity <= 66, 'medium',
                                     ifelse(spotify_songs$track_popularity <= 100, 'high'))))
