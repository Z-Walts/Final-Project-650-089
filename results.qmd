...
p <- ggplot(spotify_songs, aes(x=popularity_factor, y=minutes)) + geom_violin(trim=FALSE) + labs(title="Plot of duration by popularity level",x="Popularity level", y = "Duration in minutes")
...
```{r, message=FALSE}
#| echo: FALSE
minutes_popularity = cor.test(spotify_songs$minutes,spotify_songs$popularity,method="spearman",exact=FALSE)
